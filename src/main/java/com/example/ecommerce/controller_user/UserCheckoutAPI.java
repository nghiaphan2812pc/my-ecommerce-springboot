...
public class UserCheckoutAPI {
    ...
    public Response checkoutWithDefaultInfo(@PathVariable(value = "userID")int id){
    ...
    public Response checkoutWithNewInfo(@PathVariable(value = "userID")int id, @RequestBody CheckoutWithNewInfoRequest request){
